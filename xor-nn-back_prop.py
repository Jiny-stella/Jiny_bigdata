...
# Loss derivative
diff = (Y_pred - Y) / (Y_pred * (1.0 - Y_pred) + 1e-7)
...
predict = tf.cast(Y_pred > 0.5, dtype=tf.float32)
...
# Accuracy report
h, p, a = sess.run([Y_pred, predict, accuracy],
